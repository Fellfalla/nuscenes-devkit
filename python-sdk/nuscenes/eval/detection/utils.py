...
def detection_name_to_rel_attributes(detection_name: str):
    """
...
def center_distance(gt_box: EvalBox, pred_box: EvalBox):
    """
...
def velocity_l2(gt_box: EvalBox, pred_box: EvalBox):
    """
...
def attr_acc(gt_box: EvalBox, pred_box: EvalBox):
    """
...
def scale_iou(sample_annotation: EvalBox, sample_result: EvalBox):
    """
